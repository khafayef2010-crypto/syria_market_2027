...
class PaymentAuditRecord {
  ...
  factory PaymentAuditRecord.fromMap(Map<String, dynamic> map) =>
      PaymentAuditRecord(
        ...
        transactionRefOrTxId:
            map['transaction_ref']?.toString() ?? map['tx_id']?.toString() ?? '',
        status: map['status']?.toString() ?? 'pending',
        createdAt: map['created_at'] != null
            ? DateTime.tryParse(map['created_at'].toString()) ?? DateTime.now()
            : DateTime.now(),
...
class AppStateManager extends ChangeNotifier {
  ...
  Future<bool> signInSafe({
    ...
    String assignedPhone = currentUserPhone.isNotEmpty ? currentUserPhone : '0933000000';
    ...
    try {
      ...
      if (res is List && res.isNotEmpty) {
        ...
        exchangeRateUsdToSyp = data['usd_syp'] != null
            ? double.tryParse(data['usd_syp'].toString()) ?? exchangeRateUsdToSyp
...
class _LiveCurrencyExchangeTickerState extends State<LiveCurrencyExchangeTicker> {
  final AppStateManager _manager = AppStateManager();
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (isGold)
                const Icon(Icons.auto_awesome, color: Color(0xFFD4AF37), size: 11),
            ],
          ),
          const SizedBox(height: 4),
          Row(
  ...
  @override
  Widget build(BuildContext context) {
    final usdRate = widget.usdRate > 0 ? widget.usdRate : _manager.exchangeRateUsdToSyp;
    final goldPrice = widget.gold21kPrice > 0 ? widget.gold21kPrice : _manager.goldPrice21kSyp;
                  ...
                  if (widget.onRefresh != null) ...[
                    ...
                    InkWell(
                      ...
                      child: const Padding(
                        ...
                        child: Icon(Icons.refresh, color: Color(0xFF38BDF8), size: 14),
                      ),
                    ),
                  ],
                ],
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.copy, color: Color(0xFFD4AF37), size: 18),
                  tooltip: 'نسخ مفتاح شام كاش',
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(),
                  onPressed: () {
                    Clipboard.setData(const ClipboardData(text: kShamCashAccountKey));
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.copy, color: Color(0xFFFACC15), size: 18),
                  tooltip: 'نسخ عنوان محفظة بينانس',
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(),
                  onPressed: () {
                    Clipboard.setData(const ClipboardData(text: kBinanceWalletAddress));
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('✓ تم نسخ عنوان محفظة بينانس Binance USDT (TRC20) بنجاح!'),
...
class _DynamicPanoramasCarouselState extends State<DynamicPanoramasCarousel> {
  ...
  void _startAutoScroll() {
    ...
    final activeList = widget.banners.where((b) => b.isActive && !b.isExpired).toList();
    ...
    _autoScrollTimer = Timer(Duration(seconds: intervalSeconds), () {
      if (!_isUserInteracting && mounted && activeList.isNotEmpty && _pageController.hasClients) {
          ...
          child: Column(
            ...
            children: [
              ...
              if (manager.isModerator && widget.onUploadBannerRequested != null)
                ...
                TextButton.icon(
                  icon: const Icon(Icons.chat, size: 14, color: Color(0xFF22C55E)),
                  label: const Text(
                    'احجز خانتك في البانوراما VIP الآن 👆',
                    style: TextStyle(color: Color(0xFFD4AF37), fontSize: 11),
                  ),
                  onPressed: () => PhoneHelper.openAdminWhatsApp('مرحباً، أود حجز خانة إعلانية في البانوراما VIP.'),
                ),
            ],
          ),
        ),
...
class _VoiceInputDialogState extends State<VoiceInputDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      backgroundColor: manager.isDarkMode ? const Color(0xFF1E293B) : Colors.white,
      title: Row(
        children: [
              ...
              children: [
                ListTile(
                  ...
                  subtitle: Text(
                    ...
                    style: TextStyle(
                      color: manager.isDarkMode ? Colors.white60 : Colors.grey.shade600,
                    ),
                  ),
                  onTap: () {
                    ...
                    if (onOpenContactAdmin != null) {
                      ...
                      PhoneHelper.openAdminWhatsApp('مرحباً إدارة سوق سوريا الشامل 2028:');
                    }
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    ...
                    if (onOpenFeedback != null) {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (c) => const AppFeedbackScreen()));
                    }
                  },
                ),
                ListTile(
                ...
                if (manager.isModerator) ...[
                  Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle:
                          const Text('موافقة وإدارة المنشورات ورفضها مع الأسباب'),
                      onTap: () {
                        Navigator.pop(context);
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: manager.isDarkMode ? const Color(0xFFD4AF37) : Colors.grey.shade500,
                    fontSize: 10,
                  ),
                ),
              ],
...
class _FullAdDetailsScreenState extends State<FullAdDetailsScreen> {
  ...
  void _openDirectChat() {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('💬 جاري فتح المحادثة المباشرة مع البائع...')),
      );
    }
  }
  ...
  void _openEditScreen() {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('✏️ تعديل الإعلان متاح عبر شاشة إضافة وتعديل الإعلان.')),
      );
    }
  }
                        ...
                        Row(
                          children: [
                            CircleAvatar(
                              ...
                              backgroundColor: _manager.primaryColor,
                              backgroundImage:
                                  _currentAd.publisherAvatarUrl.isNotEmpty
                                      ? NetworkImage(
                                          _currentAd.publisherAvatarUrl)
                                      : null,
              ...
              itemBuilder: (ctx, idx) => FullAdCardItem(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (c) =>
                          FullAdDetailsScreen(ad: _sellerAds[idx]),
                    ),
                  );
                },
              ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.person, size: 11, color: Colors.grey.shade500),
                        const SizedBox(width: 3),
                        Expanded(
                          child: Text(
                            ad.publisherName,
...
class _MainDashboardScreenState extends State<MainDashboardScreen>
  ...
  static const Map<String, List<String>> _districtsMap = {
    'دمشق': ['الكل', 'الميدان', 'المزة', 'المالكي', 'أبو رمانة', 'الشعلان', 'الصالحية', 'المهاجرين', 'ركن الدين', 'القصاع', 'باب توما', 'كفرسوسة', 'البرامكة', 'دمر'],
    'ريف دمشق': ['الكل', 'جرمانا', 'صحنايا', 'أشرفية صحنايا', 'جديدة عرطوز', 'معضمية الشام', 'داريا', 'قدسيا', 'الهامة', 'الصبورة', 'يعفور', 'النبك', 'يبرود', 'التل', 'دوما', 'حرستا', 'الكسوة', 'قطنا', 'الزبداني', 'مضايا', 'بلودان'],
    'حلب': ['الكل', 'الفرقان', 'الشهباء', 'المارتيني', 'حلب الجديدة', 'السليمانية', 'العزيزية', 'الميريديان', 'سيف الدولة', 'الجميلية', 'الحمدانية', 'صلاح الدين', 'الزهراء'],
    'حمص': ['الكل', 'الحمراء', 'الإنشاءات', 'الغوطة', 'الدبلان', 'عكرمة', 'الوعر', 'كرم الشامي', 'باب السباع', 'الزهراء', 'الأرمن', 'الميدان', 'المحطة', 'القصور'],
    'حماة': ['الكل', 'الحاضر', 'الدباغة', 'المرابط', 'الصابونية', 'القصور', 'البارودية', 'شمال الخط', 'الكرامة', 'الشريعة', 'طريق حلب', 'سلمية', 'مصياف', 'محردة'],
    'اللاذقية': ['الكل', 'الصليبة', 'الرمل الشمالي', 'الزراعة', 'المشروع السابع', 'المشروع العاشر', 'الأمريكان', 'مار تقلا', 'الكورنيش الجنوبي', 'الكورنيش الغربي', 'جبلة', 'القرداحة', 'الحفة'],
    'طرطوس': ['الكل', 'المشبكة', 'الغمقة', 'الرادار', 'الكورنيش البحري', 'الحمرات', 'الإنشاءات', 'بانياس', 'صافيتا', 'الدريكيش', 'الشيخ بدر', 'مشتى الحلو'],
    'إدلب': ['الكل', 'المدينة', 'أريحا', 'معرة النعمان', 'سراقب', 'جسر الشغور', 'حارم', 'سلقين', 'الدانا', 'سرمدا', 'خان شيخون'],
    'درعا': ['الكل', 'درعا المحطة', 'درعا البلد', 'الصنمين', 'إزرع', 'طفس', 'نوى', 'داعل', 'بصرى الشام', 'جاسم', 'الحراك'],
    'السويداء': ['الكل', 'المدينة', 'شهبا', 'صلخد', 'القريا', 'شقا', 'المزرعة'],
    'القنيطرة': ['الكل', 'المدينة', 'خان أرنبة', 'البعث', 'جباتا الخشب', 'الرفيد'],
    'دير الزور': ['الكل', 'المدينة', 'الميادين', 'البوكمال', 'القصور', 'الجورة'],
    'الرقة': ['الكل', 'المدينة', 'الطبقة', 'تل أبيض'],
    'الحسكة': ['الكل', 'المدينة', 'القامشلي', 'رأس العين', 'المالكية', 'عامودا', 'الدرباسية'],
  };
  ...
  Widget _buildHomeFeedTab() {
    var filteredAds = _manager.ads.where((ad) {
      ...
      final matchesDistrict = _selectedDistrict == 'الكل' ||
          ad.neighborhood == _selectedDistrict;
      ...
      final matchesCond = _selectedCondition == 'الكل' ||
          ad.condition == _selectedCondition;
      ...
      final matchesMinP = minP == null || (ad.priceUsd != null && ad.priceUsd! >= minP);
      final matchesMaxP = maxP == null || (ad.priceUsd != null && ad.priceUsd! <= maxP);

      final matchesAuctionFilter = !_onlyAuctions || ad.isAuction;
      final matchesVerifiedFilter = !_onlyVerifiedSellers || ad.isVerifiedSeller;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.search, size: 20, color: Color(0xFFD4AF37)),
                              const SizedBox(width: 8),
                              Expanded(
                                child: TextField(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 12.5),
                                  decoration: InputDecoration(
                                    hintText: 'بحث في الإعلانات، السلع، المحافظات...',
                                    hintStyle: TextStyle(
                                      color: _manager.isDarkMode
                                          ? Colors.white38
                                          : Colors.grey,
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: const [
                              Icon(Icons.tune, color: Color(0xFF0F172A), size: 18),
                              SizedBox(width: 4),
                              Text(
                                'تصفية',
                                style: TextStyle(
                  ...
                  if (_selectedGovernorate != 'الكل' || _selectedCategory != 'الكل') ...[
                    const SizedBox(height: 6),
                        ...
                        children: [
                          if (_selectedGovernorate != 'الكل')
                            Padding(
                              ...
                              child: Chip(
                                label: Text('📍 المحافظة: $_selectedGovernorate',
              ...
              ? SliverFillRemaining(
                  ...
                  child: Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.inbox, size: 54, color: Colors.grey.withOpacity(0.5)),
                        const SizedBox(height: 12),
                        Text(
                          'لا توجد إعلانات مطابقة لمعايير البحث والفلترة',
                          style: TextStyle(
                            color: _manager.darkAdaptiveTextColor.withOpacity(0.7),
                            fontSize: 13.5,
                          ),
                        ),
                      ],
                              ...
                              return FullAdCardItem(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (ctx) => FullAdDetailsScreen(ad: ad),
                                    ),
                                  );
                                },
                              );
      ...
      itemBuilder: (ctx, idx) {
        ...
        return Card(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
            side: BorderSide(
              color: _manager.isDarkMode ? Colors.white12 : Colors.grey.shade200,
            ),
          ),
          child: ExpansionTile(
            ...
            children: cat.subcategories.map((sub) {
              return ListTile(
                dense: true,
                title: Text(sub, style: TextStyle(color: _manager.darkAdaptiveTextColor, fontSize: 12.5)),
  ...
  Widget _buildAuctionsTab() {
    final auctions = _manager.ads.where((a) => a.isAuction && a.status == 'approved').toList();
        ...
        child: Column(
          ...
          children: [
            ...
            Text('لا توجد مزادات نشطة حالياً في السوق',
                style: TextStyle(color: _manager.darkAdaptiveTextColor, fontSize: 14)),
          ],
        ),
      );
    }
  ...
  Widget _buildFavoritesTab() {
    final favs = _manager.ads.where((a) => _manager.favoriteAdIds.contains(a.id)).toList();
        ...
        child: Column(
          ...
          children: [
            ...
            Text('لم تقم بإضافة أي إعلانات إلى المفضلة بعد',
                style: TextStyle(color: _manager.darkAdaptiveTextColor, fontSize: 13)),
          ],
        ),
      );
    }
    ...
    return GridView.builder(
      ...
      itemBuilder: (ctx, idx) => FullAdCardItem(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (c) => FullAdDetailsScreen(ad: favs[idx])),
          );
        },
      ),
    );
  ...
  Widget _buildProfileTab() {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        ListTile(
          tileColor: _manager.isDarkMode ? const Color(0xFF1E293B) : Colors.white,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
          leading: const Icon(Icons.vpn_key, color: Color(0xFFD4AF37)),
          title: Text('تفعيل كود اشتراك / ترقية 🎟️',
              style: TextStyle(color: _manager.darkAdaptiveTextColor, fontWeight: FontWeight.bold, fontSize: 13)),
        ...
        ListTile(
          ...
          onTap: () {
            try {
              ...
              PhoneHelper.openAdminWhatsApp('أرغب في الاطلاع على باقات الترقية VIP المتاحة.');
            }
          },
        ),
        const SizedBox(height: 10),
        ListTile(
          tileColor: _manager.isDarkMode ? const Color(0xFF1E293B) : Colors.white,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
          leading: const Icon(Icons.account_balance_wallet, color: Color(0xFF22C55E)),
          ...
          ListTile(
            ...
            onTap: () {
              try {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('غرفة العمليات المركزية متوفرة في القسم الرابع.')),
                );
              }
            },
          ),
  ...
  void _showFilterDialog() {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: _manager.isDarkMode ? const Color(0xFF0F172A) : Colors.white,
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(top: Radius.circular(20)),
      ),
      builder: (ctx) => StatefulBuilder(
        builder: (context, setModalState) {
          final List<String> availableDistricts = _districtsMap[_selectedGovernorate] ?? ['الكل'];
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: _governoratesList
                        .map<DropdownMenuItem<String>>((String g) => DropdownMenuItem<String>(
                              value: g,
                              child: Text(g, style: TextStyle(color: _manager.darkAdaptiveTextColor)),
                            ))
                        .toList(),
                    onChanged: (String? v) {
                      if (v != null) {
                  ...
                  if (_selectedGovernorate != 'الكل')
                    DropdownButtonFormField<String>(
                      ...
                      dropdownColor: _manager.isDarkMode ? const Color(0xFF1E293B) : Colors.white,
                      decoration: const InputDecoration(labelText: 'المنطقة / الناحية', border: OutlineInputBorder()),
                      items: availableDistricts
                          .map<DropdownMenuItem<String>>((String d) => DropdownMenuItem<String>(
                                value: d,
                                child: Text(d, style: TextStyle(color: _manager.darkAdaptiveTextColor)),
                              ))
                          .toList(),
                      onChanged: (String? v) {
                        if (v != null) {
                  ...
                  DropdownButtonFormField<String>(
                    value: _sortBy,
                    dropdownColor: _manager.isDarkMode ? const Color(0xFF1E293B) : Colors.white,
                    decoration: const InputDecoration(labelText: 'الترتيب حسب', border: OutlineInputBorder()),
                    items: const [
                      DropdownMenuItem<String>(value: 'newest', child: Text('الأحدث أولاً')),
                      DropdownMenuItem<String>(value: 'price_asc', child: Text('السعر: من الأقل إلى الأعلى')),
                      DropdownMenuItem<String>(value: 'price_desc', child: Text('السعر: من الأعلى إلى الأقل')),
                    ],
                    onChanged: (String? v) {
                  ...
                  CheckboxListTile(
                    value: _onlyAuctions,
                    title: Text('عرض المزادات الحية فقط 🔨', style: TextStyle(color: _manager.darkAdaptiveTextColor, fontSize: 13)),
                    onChanged: (val) => setModalState(() => _onlyAuctions = val ?? false),
                  ),
                  CheckboxListTile(
                    value: _onlyVerifiedSellers,
                    title: Text('عرض إعلانات التجار المعتمدين فقط 🛡️', style: TextStyle(color: _manager.darkAdaptiveTextColor, fontSize: 13)),
                    onChanged: (val) => setModalState(() => _onlyVerifiedSellers = val ?? false),
                  ),
                  const SizedBox(height: 14),
                  SizedBox(
                    width: double.infinity,
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.pop(ctx);
              PhoneHelper.openAdminWhatsApp('مرحباً، أود حجز البانوراما الإعلانية رقم $slotIdx');
            },
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              style: const TextStyle(color: Color(0xFFD4AF37), fontWeight: FontWeight.bold, letterSpacing: 1.5),
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('الرئيسية والسوق', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              ...
              title: const Text('الأقسام والتصنيفات', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              ...
              title: const Text('المزادات المباشرة', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              leading: const Icon(Icons.workspace_premium, color: Color(0xFFD4AF37)),
              title: const Text('باقات الترقية VIP', style: TextStyle(color: Colors.white)),
              onTap: () {
                Navigator.pop(context);
                try {
                  Navigator.pushNamed(context, '/plans');
            ...
            if (_manager.isSuperAdmin) ...[
              ...
              ListTile(
                ...
                title: const Text('غرفة العمليات المركزية', style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.bold)),
                onTap: () {
                  Navigator.pop(context);
                  try {
                    Navigator.pushNamed(context, '/admin');
          ...
          ? FloatingActionButton.extended(
              ...
              onPressed: () {
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('شاشة إضافة الإعلان متوفرة في القسم الرابع.')),
                  );
                }
              },
            )
